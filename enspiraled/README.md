...
- can you build it again with TDD? 
- instead of a mouse over to show the children set a timeout where children appear at a random times
- make a random pallette so every circle has a different colour
- instead of just circles can you make random shapes (triangles, squares) which have different random children of their own
